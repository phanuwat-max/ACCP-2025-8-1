        ...
        <div style={{
            ...
            <div style={{
                ...
                >
                    ...
                    {tLogin('tabs.internationalPharmacist')}
                </button>
            </div>
            ...
            {/* International Pharmacist Sign Up Form */}
            {activeTab === 'international' && (
                <form>
                    <h3 style={{
                        ...
                        {tLogin('internationalPharmacist')} Registration
                    </h3>
                        ...
                        <div className="col-md-6">
                            <div style={{ marginBottom: '20px' }}>
                                <label style={{
                                    ...
                                    <i className="fa-solid fa-user" style={{ marginRight: '8px', color: '#FF6F00' }} />
                                    {t('firstName')} *
                                </label>
                                <input
                                    type="text"
                        ...
                        <div className="col-md-6">
                            <div style={{ marginBottom: '20px' }}>
                                <label style={{
                                    ...
                                    <i className="fa-solid fa-building" style={{ marginRight: '8px', color: '#FF6F00' }} />
                                    {t('organization')}
                                </label>
                                <input
                                    type="text"
                        ...
                        <div className="col-md-6">
                            <div style={{ marginBottom: '20px' }}>
                                <label style={{
                                    ...
                                    <i className="fa-solid fa-earth-americas" style={{ marginRight: '8px', color: '#FF6F00' }} />
                                    Country *
                                </label>
                                <input
                                    type="text"
                    ...
                    <div style={{ marginBottom: '20px' }}>
                        <label style={{
                            ...
                            marginBottom: '8px'
                             ...
                             <i className="fa-solid fa-id-card" style={{ marginRight: '8px', color: '#FF6F00' }} />
                            Professional License Number (Optional)
                        </label>
                        <input
                            type="text"
                            placeholder="License Number (if any)"
                            style={{
                                width: '100%',
                                padding: '14px 18px',
                                fontSize: '15px',
                    ...
                    <div style={{ marginBottom: '20px' }}>
                        <label style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', cursor: 'pointer' }}>
                            <input type="checkbox" required style={{ width: '18px', height: '18px', marginTop: '2px' }} />
                            <span style={{ fontSize: '13px', color: '#666', lineHeight: '1.5' }}>
                                {t('agreeTerms')} <Link href="/terms" style={{ color: '#FF6F00' }}>{t('terms')}</Link> {t('and')} <Link href="/privacy" style={{ color: '#FF6F00' }}>{t('privacy')}</Link>
                            </span>
                        </label>
                    </div>
